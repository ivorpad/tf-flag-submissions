...
function nexusSchemaPrisma(options) {
    ...
    return schema_1.plugin({
        ...
        onInstall: (nexusBuilder) => {
            const { types, wasCrudUsedButDisabled: wasCrudUsed } = builder_1.build(Object.assign(Object.assign({}, options), { nexusBuilder }));
...
Please add ${colors_1.colors.green(`experimentalCRUD: true`)} in the ${colors_1.colors.green('nexusPluginPrisma()')} constructor if you still wish to enable it.`);
            }
        },
    });
}
